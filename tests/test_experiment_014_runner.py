...
def sandbox(tmp_path, monkeypatch):
    ...
    (tmp_path / nf.INHERITED_013_LEDGER_RELATIVE_PATH).parent.mkdir(parents=True, exist_ok=True)
    ...
    monkeypatch.setattr(nf, "NEURON", 5)
    entries = {}
    ...
    (tmp_path / nf.INHERITED_013_LEDGER_RELATIVE_PATH).write_text(pm.canonical_json(payload) + "\n", encoding="utf-8")
