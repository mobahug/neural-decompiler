...
def _populate(root: Path, monkeypatch, fake_world):
    ...
    (root / br.INHERITED_018_EXTRACT_RELATIVE_PATH).parent.mkdir(parents=True, exist_ok=True)
    (root / br.INHERITED_018_EXTRACT_RELATIVE_PATH).write_text(extract_text, encoding="utf-8")
