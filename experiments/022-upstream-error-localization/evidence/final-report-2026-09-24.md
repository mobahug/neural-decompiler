...
- Run `be529d6f87a9f24d` at commit `0de0fb8b066876766289fd51c290a7772a452c6b`; phases: calibrate complete, confirm complete, lock complete, replicate-021 not_started, report not_started
- Design revision 4 (`219cdc5`), plan revision 3 (`e6d8299`)


## Calibration (exposed only, B = 10000)

- Re-materialized pairs: 18900; R1 max |Δc − 021| = 0.00e+00; kernel/direct max 1.3e-15 over 2816 quantities; efficiency max 2.2e-16

| condition | envelope | median of defined draws | undefined | guard-bound | PASS | ENVELOPE_ONLY | GUARD | NOT_INTERPRETABLE |
|---|---|---|---|---|---|---|---|---|
| Y1/C1 | ≥ v₍250₎ = 0.901075 | 0.9276 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |
| Y1/C2 | ≤ v₍9751₎ = 0.005595 | 0.0026 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |
| Y1/C3 | ≤ v₍9751₎ = 0.006904 | 0.0045 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |
| Y1/C4 | ≥ v₍250₎ = 0.327059 | 0.3740 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |
| Y2/C1 | ≥ v₍250₎ = 0.888785 | 0.9229 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |
| Y2/C2 | ≤ v₍9751₎ = 0.008226 | 0.0010 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |
| Y2/C3 | ≤ v₍9751₎ = 0.014172 | 0.0068 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |
| Y2/C4 | ≥ v₍250₎ = 0.207165 | 0.3001 | 0 | no | 0.975 | 0.025 | 0.000 | 0.000 |

- Joint rates (descriptive only): {'Y1_all_four_pass': 0.9074, 'Y2_all_four_pass': 0.9054, 'all_eight_pass': 0.8427, 'descriptive_only': True}
...
|---|---|---|---|---|---|---|---|
| Y1/C1 block-0 attention dominates the cue-final gap | share(Bv) + share(Bp), cue-final | 0.9479 | ≥ v₍250₎ = 0.901075 | s1 ≥ 0.5 | 0.1602 | 0.926 (10000 / 0) | **PASS** |
| Y1/C2 the layer-1–2 reductions contribute little to the cue-final gap | share(R), cue-final | -0.0000 | ≤ v₍9751₎ = 0.005595 | s2 ≤ 0.1 | 0.1602 | 0.025 (10000 / 0) | **PASS** |
| Y1/C3 the layer-1–2 reductions contribute little to the coordinated gap | share(R), coordinated | 0.0060 | ≤ v₍9751₎ = 0.006904 | s3 ≤ 0.1 | 0.3375 | 0.887 (10000 / 0) | **PASS** |
| Y1/C4 block-0 cue→target attention contributes positively to the coordinated gap | share(T), coordinated | 0.4081 | ≥ v₍250₎ = 0.327059 | s4 > 0.0 | 0.3375 | 0.895 (10000 / 0) | **PASS** |
| Y2/C1 block-0 attention dominates the cue-final gap | share(Bv) + share(Bp), cue-final | 0.9381 | ≥ v₍250₎ = 0.888785 | s1 ≥ 0.5 | 0.1599 | 0.815 (10000 / 0) | **PASS** |
| Y2/C2 the layer-1–2 reductions contribute little to the cue-final gap | share(R), cue-final | 0.0039 | ≤ v₍9751₎ = 0.008226 | s2 ≤ 0.1 | 0.1599 | 0.796 (10000 / 0) | **PASS** |
| Y2/C3 the layer-1–2 reductions contribute little to the coordinated gap | share(R), coordinated | 0.0069 | ≤ v₍9751₎ = 0.014172 | s3 ≤ 0.1 | 0.4101 | 0.520 (10000 / 0) | **PASS** |
| Y2/C4 block-0 cue→target attention contributes positively to the coordinated gap | share(T), coordinated | 0.3834 | ≥ v₍250₎ = 0.207165 | s4 > 0.0 | 0.4101 | 0.940 (10000 / 0) | **PASS** |
